    ...
    <header>
      <div>
        ...
        <nav>
          ...
          <RouterLink to="/espace-client/profil" class="inline-block m-4 font-medium text-lg underline">Profile
          </RouterLink>
          <RouterLink to="/espace-client/budget" class="inline-block m-4 font-medium text-lg underline">Budget
          </RouterLink>
        </nav>
      </div>
    </header>
